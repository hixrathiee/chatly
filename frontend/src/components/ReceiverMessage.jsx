  ...
  return (
     <div className='flex items-start gap-[10px]' >
       <div className='w-[30px] h-[30px] rounded-full  overflow-hidden flex justify-center items-center bg-white cursor-pointer shadow-gray-500 shadow-lg ' >
          ...
          <div ref={scroll} className='w-fit max-w-[500px] px-[20px] py-[10px] bg-[#1797c2] text-white text-[19px] rounded-tl-none rounded-2xl relative left-0  shadow-gray-400 shadow-lg gap-[10px] flex flex-col'>
