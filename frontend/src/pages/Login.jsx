    ...
    <div className='w-full h-[100vh] bg-slate-300 flex items-center justify-center '>
        <div className="w-full max-w-[500px] h-[600px] bg-white rounded-lg shadow-gray-400 shadow-lg flex flex-col gap-[30px]">
         ...
         <form className='w-full flex flex-col gap-[20px] items-center' onSubmit={handleLogin}>
            ...
            <button className='px-[20px] py-[10px] rounded-lg bg-[#20c7ff] shadow-gray-400 shadow-lg text-[20px] w-[190px] mt-[20px] font-semibold hover:shadow-inner cursor-pointer'  disabled={loading}>{loading?"Loading...":"Login"}</button>

            <p className='cursor-pointer' onClick={()=>navigate("/signup")}>Want to create a new Account ? <span className='text-[#20c7ff] font-bold'> Sign Up</span> </p>
         </form>
        </div>
